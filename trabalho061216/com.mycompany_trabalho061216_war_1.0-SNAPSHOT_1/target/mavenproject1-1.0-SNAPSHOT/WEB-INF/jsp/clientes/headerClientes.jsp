        ...
        <div class="navbar-header">    
            ...
            <c:if test="${!empty sessionScope.atendenteLogado}">
                ...
                <c:if test="${fn:contains(pageContext.request.requestURI, 'listar.jsp')}"> 
                    <a class="navbar-brand page-scroll" href="redirect?url=inserir">Adicionar novo cliente</a> 
                </c:if>
            </c:if>
            ...
            <c:if test="${!fn:contains(pageContext.request.requestURI, 'listar.jsp')}">   
                <a class="navbar-brand page-scroll" href="http://localhost:8084/mavenproject1/cliente/listarClientes">Gerenciar Clientes</a>               
            </c:if> 
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">                   
                <li>
                    <a class="page-scroll" href="http://localhost:8084/mavenproject1/produto/listarProdutos">Gerenciar Produtos</a>
                </li>
            </ul>
        </div> 
    </div>
